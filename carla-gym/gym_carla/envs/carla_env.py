...
class CarlaEnv(gym.Env):
  ...
  def step(self, action):
    ...
    # Apply control
    throttle=float(throttle)*0.3
    steer=float(-steer)*0.1
    brake=float(brake)
    act = carla.VehicleControl(throttle, steer, brake)
    print( "carla.VehicleControl throttle = {}, steer = {}, brake = {} ".format(throttle, steer, brake))
